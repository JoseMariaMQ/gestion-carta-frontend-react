...
const DishEdit = ({id, name, price, units, menu, price_menu, ingredients, allergens, picture}) => {
                    ...
                    editDish[0] && editDish[1] === id ? (
                        <form action="" className="mb-3">
                            <div className="form-group">
                                ...
                                <input type="text" defaultValue={name} className="form-control" placeholder="Introduce el nombre del plato"/>
                            ...
                            <div className="form-group">
                                ...
                                <input type="number" defaultValue={price} className="form-control" placeholder="Introduce el precio del plato"/>
