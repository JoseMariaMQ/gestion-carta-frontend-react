...
const FormDessert = (props) => {
    ...
    const {storeDessert} = useContext(AdminPageContext)
    ...
    const onSubmit = async (data) => {
        ...
        await storeDessert(body, media, props.section_id)
        ...
        <>
            <form onSubmit={handleSubmit(onSubmit)} className="mb-3">
                <div className="form-group">
                    ...
                    <input type="text" className="form-control" placeholder="Introduce el nombre del postre" {...register("name", {required: true})}/>
                ...
                <div className="form-group">
                    ...
                    <input type="number" step=".01" className="form-control" placeholder="Introduce el precio del postre" {...register("price", {required: true})}/>
                ...
                <div className="form-group">
                    ...
                    <input type="text" className="form-control" placeholder="Introduce los ingredientes del postre" defaultValue="" {...register("ingredients", {required: false})}/>
                    <small className="form-text text-muted"/>
                </div>
