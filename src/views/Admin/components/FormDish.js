...
const FormDish = (props) => {
    ...
    const {storeDish, updateDish} = useContext(AdminPageContext)
    ...
    const onSubmit = async (data) => {
        ...
        if (props.store) await storeDish(body, media, props.section_id)
        if (props.update) await updateDish(body, media, props.id)
        ...
        <>
            <form onSubmit={handleSubmit(onSubmit)} className="mb-3">
                <div className="form-group">
                    ...
                    <input type="text" className="form-control" placeholder="Introduce el nombre del plato" defaultValue={props.name} {...register("name", {required: true})}/>
                ...
                <div className="form-group">
                    ...
                    <input type="number" step=".01" className="form-control" placeholder="Introduce el precio del plato" defaultValue={props.price} {...register("price", {required: true})}/>
                ...
                <div className="form-group">
                    ...
                    <input type="text" className="form-control" placeholder="Introduce los ingredientes del plato" defaultValue={props.ingredients} {...register("ingredients", {required: false})}/>
                    <small className="form-text text-muted"/>
                </div>
