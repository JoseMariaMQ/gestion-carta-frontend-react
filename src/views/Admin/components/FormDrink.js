...
const FormDrink = (props) => {
    ...
    const {storeDrink} = useContext(AdminPageContext)
    ...
    const onSubmit = async (data) => {
        ...
        await storeDrink(body, media, props.section_id)
        ...
        <>
            <form onSubmit={handleSubmit(onSubmit)} className="mb-3">
                <div className="form-group">
                    ...
                    <input type="text" className="form-control" placeholder="Introduce el nombre de la bebida" {...register("name", {required: true})}/>
                ...
                <div className="form-group">
                    ...
                    <input type="number" step=".01" className="form-control" placeholder="Introduce el precio de la bebida" {...register("price", {required: true})}/>
